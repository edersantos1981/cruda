...
<div class="container-fluid bg-light card card-body">
    ...
    <div class="col-md-6 col-sm-12">
            <br />
            <p><i class="shadow-lg admin-bi bi bi-pc-display text-white bg-warning rounded-circle border-secondary" style="font-size: 2rem; padding: 1.5rem;"> </i> </p>
            <h2>Sistemas</h2>
        ...
        <div class="col-md-6 col-sm-12">
            <br />
            <p><i class="shadow-lg admin-bi bi bi-person-fill text-white bg-warning rounded-circle border-secondary" style="font-size: 2rem; padding: 1.5rem;"> </i> </p>
            <h2>Usuarios</h2>
